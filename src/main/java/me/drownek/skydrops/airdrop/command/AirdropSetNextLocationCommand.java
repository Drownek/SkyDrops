...
@Permission("skydrops.command.setnextlocation")
public class AirdropSetNextLocationCommand {

    private @Inject AirdropTask airdropTask;

    @Execute(name = "set-next-location")
    void setNextLocation(@Context Player player, @Arg Location location) {
